# Notes (Day 16) - Core Java, Volume I  - Chapter 3
...
## Enumerated Types
An enumerated type is a type that consists of a fixed set of constants. An enumerated type is defined using the `enum` keyword.
